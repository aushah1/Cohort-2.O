...
// It will be very difficult to make 10 laptops with different data , it will make the code long and jumbled making it difficult to understand it later.
...
class Employee {
  constructor() {
    this.username = "Aushah";
    this.salary = 10000000;
  }
  showDetails = function () {
    console.log(this.username, this.salary);
  };
}
...
//It makes the code short and easy to understand and make the code managable
...
let acc1 = new BankAccount("Aushah", 1000);
acc1.deposit(400);
let acc2 = new BankAccount("Adiva", 200);

//because both the accounts have their own name and balance .
...
profile.printName();
//beacuse ethe value of this changes from profile obj to global obj

// structor Function and Prototype
...
let v1 = new Vehicle("Swift", 4);
let v2 = new Vehicle("truck", 8);
let v3 = new Vehicle("plane", 4);
let v4 = new Vehicle("bike", 2);

//protype  approach saves the memory by creating a single method that is shared by all.
...
//call hepls to run the function with specific this value
...
introduce.apply(obj, ["Anantnag", "Developer"]);

// call accepts the arguments simply while as apply accepts the arguments as array
...
let fnc = greet.bind(obj3);
fnc();

// bind binds the this value to an object permanently , even if we use it later or inside a callback , it knows which obj's this to use
